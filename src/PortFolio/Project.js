...
function Project() {
  const ProjectData = [
    {
      ProjectTitle: "E - Recipes",
      ProjectLink: "https://e-recipes.netlify.app/",
      ProjectImage: Project3,
      Date: "June 2022",
      LanguagesUsed: ["HTML5", "CSS3", "JAVASCRIPT(ES6)", "TAILWIND", "REACT JS"],
      ProjectDescription: "This Project is related to Food Recipes Finder where a user can search food and get the data related to it like summary, steps to cook , ingredients,health score,veg or nonveg , etc.It is Created using Spoonculer API"
    },
    {
      ProjectTitle: "Waadu Blogs",
      ProjectLink: "https://waadu-blog.netlify.app/",
      ProjectImage: Project4,
      Date: "May 2022",
      LanguagesUsed: ["HTML5", "CSS3", "JAVASCRIPT(ES6)", "TAILWIND","BOOTSTRAP 5" ,"REACT JS"],
      ProjectDescription: "This Project is related to Blog creating website where we can create blogs with images using different categories.Its just a Design Project."
    },
    {
